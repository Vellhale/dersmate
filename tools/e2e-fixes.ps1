...
$reg = Send Post '/api/auth/register' @{ email = $bekleyenMail; password = 'Demo12345'; displayName = "Fixd $stamp"; termsVersion = (& "$PSScriptRoot\yasal-surum.ps1"); ageConfirmed = $true; hwidHash = (NewHwid) } $null
...
try {
    Send Post '/api/auth/register' @{ email = $bekleyenMail; password = 'Demo12345'; displayName = 'tekrar'; termsVersion = (& "$PSScriptRoot\yasal-surum.ps1"); ageConfirmed = $true; hwidHash = (NewHwid) } $null | Out-Null
